...
img=Image.open('https://github.com/rima-w/StreamlitAssignment/blob/main/games.png')
...
img2=Image.open('https://github.com/rima-w/StreamlitAssignment/blob/main/ea_acti.jpg')
...
img3=Image.open('https://github.com/rima-w/StreamlitAssignment/blob/main/platforms.jpg')
...
img4=Image.open('https://github.com/rima-w/StreamlitAssignment/blob/main/wii.jpg')
st.markdown("#### Winner!")
