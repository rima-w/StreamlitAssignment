...
# DATA AND PLOTS
df = pd.read_csv("C:/Users/MEPI-TLG/Downloads/vgsales.csv", index_col =[0])
# print(df.head(3))
...
img=Image.open('C:/Users/MEPI-TLG/Downloads/games.png')
...
img2=Image.open('C:/Users/MEPI-TLG/Downloads/ea_acti.jpg')
...
img3=Image.open('C:/Users/MEPI-TLG/Downloads/platforms.jpg')
...
img4=Image.open('C:/Users/MEPI-TLG/Downloads/wii.jpg')
st.markdown("#### Winner!")
